...
//   return (
//     <div className=" max-w-[1140px] mx-auto px-4 sm:px-6 lg:px-0 py-20">
//       <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
//         {resorts.map((resort) => (
//           <div
//             key={resort.id}
//             className="bg-white rounded-md shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 group"
//           >
//             {/* Image */}
...
//             {/* Content */}
//             <div className=" hd  transform transition-all duration-500 group-hover:-translate-y-2  ">
//                 <div className=" p-4 bg-white group-hover:rounded-t-sm">

               
//               <p className="text-[#aca188] text-sm">{resort.country}</p>
//               <h3 className=" hd text-[16px] font-[500] text-[#2e2c2d] mt-1">
//                 {resort.name}
//               </h3>

//               {/* Tags */}
//               <div className=" hd mt-2 flex flex-wrap gap-2 text-[12px]  font-[500]">
...
const PropertiesCards = () => {
  ...
  const totalPages = Math.ceil(resorts.length / cardsPerPage);
...
//   const sectionRef = useRef(null);
  ...
  const currentCards = resorts.slice(indexOfFirstCard, indexOfLastCard);
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {currentCards.map((resort, index) => (
          ...
          >
            ...
            {/* Content */}
            <div className=" hd transition-all duration-500 group-hover:-translate-y-2">
              <div className="p-4 bg-white group-hover:rounded-t-sm">
                <p className="text-[#aca188] text-sm">{resort.country}</p>
