  ...
  return (
    <div className=" hd flex gap-4 border border-gray-300 rounded-xl  mb-4 bg-white shadow-sm">
      ...
      <div className="flex-1 flex flex-col justify-between p-4">
        <div>
          <p className="hd  text-[#2e2c2d]">{property.distance} to center</p>

          <h2 className="hd text-[18px] font-semibold text-[#2e2c2d]  tracking-wide capitalize">{property.title}</h2>
        ...
        <div className="flex justify-between items-end">
          ...
          <div className=" hd text-right">
            <p className="text-[#2e2c2d] font-semibold">${property.price}</p>
