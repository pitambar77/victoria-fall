...
// //       {/* Dynamic Business Info Fields */}
// //       {selectedRole && roleFields[selectedRole]?.businessInfo ? (
...
// //                   className="border border-gray-300 rounded-md w-full p-2 focus:outline-none focus:ring-1 focus:ring-[#aca188] min-h-[100px]"
// //                 />
// //               ) : field.type === "select" ? (
// //                 <select
// //                   name={field.name}
...
// //         </div>
// //       ) : (
// //         <p className="text-gray-500 italic">Please select a role type to continue.</p>
// //       )}
// //     </div>
// //   );
// // };
