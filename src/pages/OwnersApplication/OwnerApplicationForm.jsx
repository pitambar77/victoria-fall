...
// import Step4ProfileMedia from "./Step4ProfileMedia";
// import ProgressBar from "./ProgressBar";
// import { roleFields } from "../../data/roleFields"; // 👈 import your field config
...
//     phone: "",
//     wpnumber: "",
//     roleType: "", // 👈 determines which form to show & submit
...
//   // 🧩 Filter fields dynamically by role
//   const getFilteredFormData = () => {
//     const role = formData.roleType;
//     if (!role || !roleFields[role]) return formData;

//     const allFields = [
//       ...(roleFields[role].businessInfo || []),
//       ...(roleFields[role].legalInfo || []),
//       ...(roleFields[role].profileMedia || []),
//     ];

//     const allowedKeys = allFields.map((field) => field.name);
