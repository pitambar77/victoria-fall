...
//     try {
//       const response = await fetch("http://localhost:8000/api/restaubookings", {
//         method: "POST",
...
//           your special moment
//         </p>
//         <h2 className="hd text-[20px] md:text-[30px]  text-center font-semibold text-[#2e2c2d] tracking-[3px] uppercase mb-6">
//           book a table
//         </h2>
//         <p
//           className={`hd max-w-2xl mx-auto text-justify md:text-center text-[#5c5e62] tracking-[1px] italic mb-10 `}
//         >
...
//           className="hd w-full sm:w-2/3 md:w-2/3 lg:w-1/2 p-4 relative z-30"
//         >
...
//               name="name"
//               placeholder="Name*"
//               className="p-3 outline-0 border border-white/80 focus:border-white rounded-md placeholder-white/80 text-sm"
//               required
//             />
//             <input
//               type="email"
...
//               type="time"
//               name="time"
//               className="p-3 outline-0 border border-white/80 focus:border-white rounded-md text-white/80 text-sm"
//             />
//             <input
//               type="date"
//               name="bookingDate"
