...
//         ${index === 3 ? "lg:col-start-2" : ""}`} // center the 4th card
//     >
//       <Link to={''}>
//         {/* Image */}
//         <div className="h-[200px] w-full overflow-hidden">
...
//         <div className="hd transition-all duration-500 group-hover:-translate-y-4">
//           <div className="p-4 bg-white group-hover:rounded-t-md text-center">
//             <h3 className="text-lg font-[600] text-[#2e2c2d] mt-1 uppercase">
//               {activity.destination}
//             </h3>
//             <button className="my-2 text-[#2e2c2d] border border-[#aca188] rounded-md text-[14px] leading-[1.6] uppercase tracking-[3px] font-normal py-[8px] px-[20px] transition-colors duration-300 cursor-pointer ease-out">
//               View Details
//             </button>
//           </div>
//         </div>
