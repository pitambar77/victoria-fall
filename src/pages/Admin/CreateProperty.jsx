...
export default function CreateProperty() {
  ...
  const nextStep = () => {
    ...
    //     if (!rule.title?.trim()) {
    //       setErrors({
    //         [`rule_${i}`]: "Policy title is required",
    //       });
    //       return;
    //     }
    //   }
    ...
    //   if (blocks.length === 0) {
    //     setErrors({
    //       incidental_0: "At least one section is required",
    //     });
    //     return;
    //   }
  ...
  for (let i = 0; i < images.length; i++) {
    ...
    //   if (images.length === 0) {
    //     setErrors({
    //       imageName_0: "At least one image is required",
    //     });
    //     return;
    //   }
    ...
    //   if (images.length < 6) {
    //     setErrors({
    //       gallery: "Minimum 6 images required",
    //     });
    //     return;
    //   }
    ...
    //     if (!img.imageName?.trim()) {
    //       setErrors({
    //         [`imageName_${i}`]: "Image title required",
    //       });
    //       return;
    //     }
    ...
    //     if (!img.imageCategory) {
    //       setErrors({
    //         [`imageCategory_${i}`]: "Image category required",
    //       });
    //       return;
    //     }
    ...
    //     if (!img.image) {
    //       setErrors({
    //         [`image_${i}`]: "Image upload required",
    //       });
    //       return;
    //     }
    //   }
